...
//         m_model_->m_main_ecg_chart = lv_chart_create(active_view);
//         lv_obj_set_height(m_model_->m_main_ecg_chart, 140);
//         lv_obj_set_width(m_model_->m_main_ecg_chart, lv_pct(90));
//         lv_obj_set_x(m_model_->m_main_ecg_chart, 0);
//         lv_obj_set_y(m_model_->m_main_ecg_chart, -75);
//         lv_obj_set_align(m_model_->m_main_ecg_chart, LV_ALIGN_CENTER);
//         lv_obj_add_flag(m_model_->m_main_ecg_chart,
//                         LV_OBJ_FLAG_OVERFLOW_VISIBLE);      //make scales visible - Should it be forced to True?
//         //lv_obj_remove_flag( m_model_->m_main_ecg_chart, LV_OBJ_FLAG_SCROLLABLE );    //no chart-zoom in LVGL9 - Shouldn't it be forced to False?
//         lv_chart_set_type(m_model_->m_main_ecg_chart, LV_CHART_TYPE_LINE);
//         lv_chart_set_point_count(m_model_->m_main_ecg_chart, 40);
//         lv_chart_set_div_line_count(m_model_->m_main_ecg_chart, 5, 10);

//         lv_obj_t *ui_mainEcgChart_Xaxis = lv_scale_create(m_model_->m_main_ecg_chart);
...
//         lv_obj_set_y(ui_mainEcgChart_Xaxis, 50 + lv_obj_get_style_pad_bottom(m_model_->m_main_ecg_chart,
//                                                                             LV_PART_MAIN) + lv_obj_get_style_border_width(m_model_->m_main_ecg_chart, LV_PART_MAIN));
...
//         lv_obj_t * ui_mainEcgChart_Yaxis1 = lv_scale_create(m_model_->m_main_ecg_chart);
...
//         lv_obj_set_x(ui_mainEcgChart_Yaxis1, -50 - lv_obj_get_style_pad_left(m_model_->m_main_ecg_chart,
//                                                                             LV_PART_MAIN) - lv_obj_get_style_border_width(m_model_->m_main_ecg_chart, LV_PART_MAIN) + 2);
...
//         lv_obj_t *ui_mainEcgChart_Yaxis2 = lv_scale_create(m_model_->m_main_ecg_chart);
...
//         lv_obj_set_x(ui_mainEcgChart_Yaxis2, 25 + lv_obj_get_style_pad_right(m_model_->m_main_ecg_chart,
//                                                                             LV_PART_MAIN) + lv_obj_get_style_border_width(m_model_->m_main_ecg_chart, LV_PART_MAIN) + 1);
...
//         m_model_->m_main_ecg_chart_series = lv_chart_add_series(m_model_->m_main_ecg_chart, lv_color_hex(0xDA1905), LV_CHART_AXIS_PRIMARY_Y);

//         //This workaround (an invisible outline) is needed because without it chart overflow-visible doesn't work in LVGL-9.1
//         lv_obj_set_style_outline_pad(m_model_->m_main_ecg_chart, LV_MAX3(50, 50, 25), LV_STATE_DEFAULT);   //workaround for ineffective 'overflow visible' flag
//         lv_obj_set_style_outline_width(m_model_->m_main_ecg_chart, -1, LV_STATE_DEFAULT);

//         m_model_->m_main_oxygen_chart = lv_chart_create(active_view);
//         lv_obj_set_height(m_model_->m_main_oxygen_chart, 140);
//         lv_obj_set_width(m_model_->m_main_oxygen_chart, lv_pct(90));
//         lv_obj_set_x(m_model_->m_main_oxygen_chart, 0);
//         lv_obj_set_y(m_model_->m_main_oxygen_chart, 105);
//         lv_obj_set_align(m_model_->m_main_oxygen_chart, LV_ALIGN_CENTER);
//         lv_obj_add_flag(m_model_->m_main_oxygen_chart,
//                         LV_OBJ_FLAG_OVERFLOW_VISIBLE);      //make scales visible - Should it be forced to True?
//         //lv_obj_remove_flag( m_model_->m_main_oxygen_chart, LV_OBJ_FLAG_SCROLLABLE );    //no chart-zoom in LVGL9 - Shouldn't it be forced to False?
//         lv_chart_set_type(m_model_->m_main_oxygen_chart, LV_CHART_TYPE_LINE);
//         lv_chart_set_point_count(m_model_->m_main_oxygen_chart, 40);
//         lv_chart_set_div_line_count(m_model_->m_main_oxygen_chart, 5, 10);

//         lv_obj_t *ui_mainOxygenChart_Xaxis = lv_scale_create(m_model_->m_main_oxygen_chart);
...
//         lv_obj_set_y(ui_mainOxygenChart_Xaxis, 50 + lv_obj_get_style_pad_bottom(m_model_->m_main_oxygen_chart,
//                                                                                 LV_PART_MAIN) + lv_obj_get_style_border_width(m_model_->m_main_oxygen_chart, LV_PART_MAIN));
...
//         lv_obj_t *ui_mainOxygenChart_Yaxis1 = lv_scale_create(m_model_->m_main_oxygen_chart);
...
//         lv_obj_set_x(ui_mainOxygenChart_Yaxis1, -50 - lv_obj_get_style_pad_left(m_model_->m_main_oxygen_chart,
//                                                                                 LV_PART_MAIN) - lv_obj_get_style_border_width(m_model_->m_main_oxygen_chart, LV_PART_MAIN) + 2);
...
//         lv_obj_t *ui_mainOxygenChart_Yaxis2 = lv_scale_create(m_model_->m_main_oxygen_chart);
...
//         lv_obj_set_x(ui_mainOxygenChart_Yaxis2, 25 + lv_obj_get_style_pad_right(m_model_->m_main_oxygen_chart,
//                                                                                 LV_PART_MAIN) + lv_obj_get_style_border_width(m_model_->m_main_oxygen_chart, LV_PART_MAIN) + 1);
...
//         m_model_->m_main_oxygen_chart_series = lv_chart_add_series(m_model_->m_main_oxygen_chart, lv_color_hex(0xDA1905),LV_CHART_AXIS_PRIMARY_Y);

//         //This workaround (an invisible outline) is needed because without it chart overflow-visible doesn't work in LVGL-9.1
//         lv_obj_set_style_outline_pad(m_model_->m_main_oxygen_chart, LV_MAX3(50, 50, 25), LV_STATE_DEFAULT);   //workaround for ineffective 'overflow visible' flag
//         lv_obj_set_style_outline_width(m_model_->m_main_oxygen_chart, -1, LV_STATE_DEFAULT);
//     }
// }
